...
public static class SecurityLoggerExtensions
{
    ...
    public static void LogSecurityTrace(this ILogger logger, Exception? exception, string? message, params object?[] args) =>
        logger.LogTrace(SecurityEventId, exception, message, args);
    ...
    public static void LogSecurityDebug(this ILogger logger, Exception? exception, string? message, params object?[] args) =>
        logger.LogDebug(SecurityEventId, exception, message, args);
    ...
    public static void LogSecurityInformation(this ILogger logger, Exception? exception, string? message, params object?[] args) =>
        logger.LogInformation(SecurityEventId, exception, message, args);
    ...
    public static void LogSecurityWarning(this ILogger logger, Exception? exception, string? message, params object?[] args) =>
        logger.LogWarning(SecurityEventId, exception, message, args);
    ...
    public static void LogSecurityError(this ILogger logger, string? message, params object?[] args) =>
        logger.LogError(SecurityEventId, message, args);
    ...
    public static void LogSecurityCritical(this ILogger logger, Exception? exception, string? message, params object?[] args) =>
        logger.LogCritical(SecurityEventId, exception, message, args);
}
